...
public class Monument_Reg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monument__reg);
        ...
        viewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Monument_Reg.this, ViewImageActivity.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toasty.info(Monument_Reg.this, "Uploading......", Toast.LENGTH_SHORT, true).show();
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toasty.success(Monument_Reg.this, "Upload Successfully....", Toast.LENGTH_SHORT, true).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Monument_Reg.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(Monument_Reg.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}
